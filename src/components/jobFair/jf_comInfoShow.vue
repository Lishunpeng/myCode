...
<script>
	...
	export default { 
  		...
  		created(){
  			...
  			this.getJFId = this.$route.query.jfId;
  			console.log('/app/recruitJobFairShow'+this.page+'-'+this.getComId+'-'+this.getJFId)
  			this.myfun.getAxios({path:'/app/recruitJobFairShow/'+this.page+'-'+this.getComId+'-'+this.getJFId},res=>{
